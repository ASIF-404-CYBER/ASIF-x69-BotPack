...
name : ```Xnil Developer```</br>
age : ```17```</br>
link : [facebook](https://www.facebook.com/profile.php?id=100000768468627).</br>

## CREDITS

original file : [BotPack](https://replit.com/@X-NiL-XHOWDHURY/Xnil-Botpack) by ```YanMaglinte```</br>
modified : [X-NiL](https://replit.com/@X-NiL-XHOWDHURY/) by ```X-NiL Developer```

## UPDATES

• configure console output in ``xnil/configs/console.js``.</br>
...
xnil.js : ``configure auto restart and auto accept pending messages.``</br>
xnil.json : ``configure bot name, bot prefix, bot operators and admins.``</br>
xnilstate.json : ``account cache data.``
...
## HOW TO GET 'XNILSTATE.JSON' DATA?
